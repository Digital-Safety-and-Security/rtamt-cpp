#include "stl_multiplication_node.hpp"
...
StlMultiplicationNode::StlMultiplicationNode(StlNode* left_child, StlNode* right_child) {
...
void StlMultiplicationNode::accept(StlVisitor& v) {
  v.visit(this);
}
