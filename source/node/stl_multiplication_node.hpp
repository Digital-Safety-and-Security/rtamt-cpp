...
#define STL_MULTIPLICATION_NODE_H
 ...
 * STL Multiplication operation and implements the monitoring algorithm
 * for computing it.
 *
 */
...
public:
   ...
   */
  StlMultiplicationNode(StlNode* left_child, StlNode* right_child);
  /**
   * @brief Monitoring algorithm computing the multiplication.
   *
   * @return node::Sample
   */
  ...
  ~StlMultiplicationNode() override = default;

  /**
   * @brief Reset the internal state of STL Multiplication node.
   *
   */
  void reset() override {}
};
